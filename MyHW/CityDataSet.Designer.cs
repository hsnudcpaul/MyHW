    ...
    public partial class CityDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationCity_Photo = new global::System.Data.DataRelation("City_Photo", new global::System.Data.DataColumn[] {
                        ...
                        this.tablePhoto.CityColumn}, false);
        ...
        public partial class PhotoDataTable : global::System.Data.TypedTableBase<PhotoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PhotoRow AddPhotoRow(string PhotoName, CityRow parentCityRowByCity_Photo, byte[] Photo) {
        ...
        public partial class PhotoRow : global::System.Data.DataRow {
            ...
            public int City {
                get {
                    return ((int)(this[this.tablePhoto.CityColumn]));
                }
                set {
...
namespace MyHW.CityDataSetTableAdapters {
    ...
    public partial class PhotoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Photo] WHERE (([PhotoID] = @Original_PhotoID) AND ((@IsNull_Ph" +
                "otoName = 1 AND [PhotoName] IS NULL) OR ([PhotoName] = @Original_PhotoName)) AND" +
                " ([City] = @Original_City))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Photo] ([PhotoName], [City], [Photo]) VALUES (@PhotoName, @Cit" +
                "y, @Photo);\r\nSELECT PhotoID, PhotoName, City, Photo FROM Photo WHERE (PhotoID = " +
                "SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Photo] SET [PhotoName] = @PhotoName, [City] = @City, [Photo] = @Photo WHERE (([PhotoID] = @Original_PhotoID) AND ((@IsNull_PhotoName = 1 AND [PhotoName] IS NULL) OR ([PhotoName] = @Original_PhotoName)) AND ([City] = @Original_City));
SELECT PhotoID, PhotoName, City, Photo FROM Photo WHERE (PhotoID = @PhotoID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MyHW.Properties.Settings.Default.CityPhConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PhotoID, PhotoName, City, Photo FROM dbo.Photo";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT PhotoID,PhotoName,City,Photo FROM dbo.Photo as p join City as c on p.City=" +
                "c.CityID  where CityName= @city";
        ...
        public virtual int Fill(CityDataSet.PhotoDataTable dataTable) {
        ...
        public virtual CityDataSet.PhotoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CityDataSet.PhotoDataTable dataTable = new CityDataSet.PhotoDataTable();
        ...
        public virtual int FillByCitySearch(CityDataSet.PhotoDataTable dataTable, string city) {
        ...
        public virtual CityDataSet.PhotoDataTable GetDataByCitySearch(string city) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((city == null)) {
                throw new global::System.ArgumentNullException("city");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CityDataSet.PhotoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_PhotoID, string Original_PhotoName, int Original_City) {
            ...
            if ((Original_PhotoName == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_PhotoName));
            }
        ...
        public virtual int Insert(string PhotoName, int City, byte[] Photo) {
            if ((PhotoName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(City));
            if ((Photo == null)) {
        ...
        public virtual int Update(string PhotoName, int City, byte[] Photo, int Original_PhotoID, string Original_PhotoName, int Original_City, int PhotoID) {
            if ((PhotoName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(City));
            if ((Photo == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_City));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PhotoName, int City, byte[] Photo, int Original_PhotoID, string Original_PhotoName, int Original_City) {
            return this.Update(PhotoName, City, Photo, Original_PhotoID, Original_PhotoName, Original_City, Original_PhotoID);
        }
    }
    ...
    public partial class CityTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT CityID FROM dbo.City where CityName = @city";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@city", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "CityName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByGetCity(CityDataSet.CityDataTable dataTable, string city) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((city == null)) {
                throw new global::System.ArgumentNullException("city");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual CityDataSet.CityDataTable GetDataByGetCity(string city) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((city == null)) {
                throw new global::System.ArgumentNullException("city");
            }
